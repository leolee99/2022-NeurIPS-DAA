...
class PrecompDataset(data.Dataset):
    ...
    def __init__(self, data_path, data_split, vocab):
        ...
        self.tfidf_map = None
        tfidf = h5py.File(self.CIDEr_path,'r')['TFIDF']
        self.tfidf_shape = (len(tfidf), len(tfidf[0]))
    ...
    def __getitem__(self, index):
        ...
        sem_GT = self.tfidf_map['TFIDF'][self.index2beg[index]: self.index2beg[index] + 5]
